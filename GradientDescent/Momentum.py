...
from Util import MNIST, error_rate, cost, y2indicator
from GradientDescent import forward, derivative_w2, derivative_b2, derivative_w1, derivative_b1
...
def main():
	...
	max_iter = 20 # 30 for sigmoid, 20 for tanh
	print_period = 10
	...
	# define dimensions and initialize weights
	M = 300
	K = 10
	...
	LL_momentum, CR_momentum = [], []
	mu = 0.9
	dW2, db2, dW1, db1 = 0, 0, 0, 0
